...
//
// let linkAbout = document.querySelector('.sidebar-menu-link.about a');
// let linkHelp = document.querySelector('.sidebar-menu-link.help a');
// let linkAlphaPlus = document.querySelector('.sidebar-menu-link.alpha-plus a');
// let linkBlog = document.querySelector('.sidebar-menu-link.blog a');
// let linkEquality = document.querySelector('.sidebar-menu-link.equality a');
// let linkCareers = document.querySelector('.sidebar-menu-link.careers a');
// let linkTerms = document.querySelector('.sidebar-menu-link.terms a');
// let linkPrivacy = document.querySelector('.sidebar-menu-link.privacy a');
// let linkCookie = document.querySelector('.sidebar-menu-link.cookie a');
// let linkEula = document.querySelector('.sidebar-menu-link.eula a');
//
// const blockItem = document.querySelectorAll('.block-item');
//
// let blockAbout = document.querySelector('.block-about');
// let blockHelp = document.querySelector('.block-help');
// let blockAlphaPlus = document.querySelector('.block-alpha');
// let blockBlog = document.querySelector('.block-blog');
// let blockEquality = document.querySelector('.block-alpha-for-equality');
// let blockCareers = document.querySelector('.block-careers');
// const blockTerms = document.querySelector('.block-terms-of-service');
// let blockCookie = document.querySelector('.block-cookie');
// let blockEula = document.querySelector('.block-eula');
//
// const currentUrl = location.hash;
//
// const url = location.href;
// if (url == 'https://www.kiridating.com/privacy.php') {
...
//
//
// if (document.querySelector('.block-help-form-support-textarea')) {
//     document.querySelector('.block-help-form-support-textarea').innerHTML = '';
//
// }
//
