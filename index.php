...
<head>
  ...
  <meta property="og:description" content="Find exactly who you like by using Kiri's powerful search and filters. View and chat with Kiri members from your neighborhood or around the globe.">
  ...
  <meta name="twitter:description" content="Find exactly who you like by using Kiri's powerful search and filters. View and chat with Kiri members from your neighborhood or around the globe.">
            ...
            <div class="block-home-content-photo">
              <div class="wrapper-block-home-content-photo-img">
                <picture>
                  ...
                  <img class="block-home-content-photo-img" src="./images/Screen.jpg" alt="About Photo">
                </picture>
              </div>
            ...
            <div class="block-help-content-choose-tab" data-aboutchoosetab="guide">
              ...
              <div class="block-help-content-row">
                ...
                <ul class="block-help-content-row-list guide">
                  <li class="block-help-content-row-list-item minus" data-helpchooseitem="whatalpha">What is Kiri? <span class="icon-plus"></span>
                  </li>
                  ...
                  <li class="block-help-content-row-wrapper-container-mobile" data-helpchoosecontentmobile="creating">
                    ...
                    <ul class="block-help-content-row-container-list disc">
                      <li>iOS: Download
                        <a class="block-help-content-link" href="https://apps.apple.com/us/app/alpha-gay-dating-chat/id1581642080">Kiri
                          here</a>
                      </li>
                      <li>Android: Download
                        <a class="block-help-content-link" href="https://play.google.com/store/apps/details?id=com.alphadatingapp">Kiri
                          here</a>
                      </li>
                    </ul>
                  ...
                  <li class="block-help-content-row-wrapper-container-mobile" data-helpchoosecontentmobile="alpha">
                    ...
                    <p class="block-help-content-row-container-text">
                      <span class="block-help-content-row-container-text-bold">Viewed Me</span>— See who's checking you out.
                    </p>
                    <p class="block-help-content-row-container-text">
                ...
                <ul class="block-help-content-row-list troubleshooting">
                  ...
                  <li class="block-help-content-row-wrapper-container-mobile" data-helpchoosecontentmobile="report">
                    ...
                    <form method="POST" class="block-help-form" id="submit-report-form" autocomplete="off">
                      ...
                      <textarea class="block-help-form-input" name="name" placeholder="Write your message here" autocomplete="off" required="" oninput="auto_grow(this)"></textarea>
                ...
                <div class="block-help-content-row-wrapper troubleshooting">
                  ...
                  <div class="block-help-content-row-wrapper-container active" data-helpchoosecontent="report">
                    ...
                    <form method="POST" class="block-help-form" id="submit-report-form-desktop" autocomplete="off">
                      <textarea class="block-help-form-input" type="text" id="report_second" name="report_second" placeholder="Write your message here" autocomplete="off" required="" oninput="auto_grow(this)"></textarea>
                      <div class="response"></div>
            ...
            <div class="block-help-content-choose-tab" data-aboutchoosetab="safety">
              ...
              <div class="block-help-content-row">
                <ul class="block-help-content-row-list safety">
                  ...
                  <li class="block-help-content-row-wrapper-container-mobile" data-helpchoosecontentmobile="beAwareTraveling">
              ...
              <div class="block-help-content-row">
                <form method="POST" class="form-support" id="submit-support-form" autocomplete="off">
                  <div class="wrapper-support-fields">
                    ...
                    <textarea class="block-help-form-support-textarea" name="message" id="message" cols="50" rows="3" placeholder="Enter your Message">
                </textarea>
                  </div>
            ...
            <div class="block-alpha-content-description">
              ...
              <div class="block-alpha-content-photo-mobile">
                <div class="wrapper-block-alpha-content-photo-img">
                  <picture>
                    <source srcset="./images/Screen.webp" type="image/webp">
                    <img class="block-alpha-content-photo-img" src="./images/Screen.webp" alt="About Photo">
                  </picture>
                </div>
        ...
        <div class="block-item block-terms-of-service" id="terms" data-block="#termsOfService">
          <div class="block-terms-of-service-content">
            ...
            <p class="terms-text">
              ...
              Store account or through Kiri, please contact <a class="terms-link" href="mailto:support@kiriapp.com">Customer
                support.</a>
            </p>
            ...
            <p class="terms-text"> You can create an Account via manual registration, or by using your
              ...
              about what information we use and how we use it, please check out our <a class="terms-link privacy" href="https://kiridating.com/privacy.php">Privacy
                Policy.</a></p>
            ...
            <p class="terms-text">
              You agree that Your Content must comply with our Guidelines at <a class="terms-link" href="mailto:support@kiriapp.com">
                https://Kiri
            ...
            <p class="terms-text">
              ...
              your personal data, please check out our <a class="terms-link privacy" href="https://kiridating.com/privacy.php">Privacy
                Policy.</a> By using Kiri ,
              you acknowledge that we may use such data in accordance with our
              <a class="terms-link privacy" href="https://kiridating.com/privacy.php">Privacy
                Policy.</a>
            </p>
            <!-- -->
            ...
            <p class="terms-text">
              ...
              retains your information, please read the <a class="terms-link privacy" href="https://kiridating.com/privacy.php">Privacy
                Policy.</a></p>
